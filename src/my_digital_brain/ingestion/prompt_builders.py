...
class IngestionPromptBuilder:
    ...
    extractor_system_prompt = (
        "# Role\n"
        "You're a network graph ingestion extractor.\n\n"
        "# Task\n"
        ...
        "- Do not invent missing identity details. Preserve the best supported "
        "ambiguous name and mark the relevant ambiguity instead of dropping the "
        "candidate.\n"
        "- Extraction produces candidates; identity resolution decides whether to "
        "ask a clarification and which terminal action to propose.\n"
        ...
        "- When an entity is ambiguous and more identity information may help, ask "
        "for clarification before proposing a node action. After an answer, apply "
        "the clarified value to the structured candidate fields, not only to the "
        "reason. Use defer_or_ignore only when the user explicitly asks not to save "
        "or to defer the candidate.\n\n"
        "# Context\n"
