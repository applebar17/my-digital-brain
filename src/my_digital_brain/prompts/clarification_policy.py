...
CLARIFICATION_POLICY = (
    ...
    "- Treat these as real identity gaps before creating or attaching a durable Person: "
    "a first-name-only mention; an unexplained nickname; two plausible existing matches; "
    "or an unclear relationship endpoint. Ask unless the active context already supplies "
    "a stable matching ref, or the source explicitly maps the mention to a full identity.\n"
    "- A full name, an explicit nickname-to-full-name mapping, or one unambiguous supplied "
    "existing ref is enough to continue without clarification. Do not ask for optional "
    "biographical detail after identity is already safe.\n"
