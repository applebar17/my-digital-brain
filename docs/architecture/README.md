...
| `agentic-orchestration.md` | Review complete. Its state, context, toolbox, and prompt principles have canonical AI-engineering owners; its pending-process and handoff runtime is retired. Delete after the remaining development-plan inbound links are removed. |
